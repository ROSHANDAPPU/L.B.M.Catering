    ...
    <div className="min-h-screen bg-[#EFE3D7]">
      ...
      <div 
        ...
        style={{ 
          height: '70vh', 
          marginTop: '80px',
          backgroundImage: `linear-gradient(rgba(54, 57, 76, 0.75), rgba(91, 46, 52, 0.75)), url('https://images.unsplash.com/photo-1758810742443-b82f48355828?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVnYW50JTIwY2F0ZXJpbmclMjB0YWJsZSUyMHNldHVwfGVufDF8fHx8MTc1OTk5NjExMnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral')`,
          backgroundSize: 'cover',
          backgroundPosition: 'center',
      ...
      >
        ...
        >
          <h1 className="text-[#EFE3D7] mb-6">Our Menu</h1>
          <p className="text-[#EFE3D7]/90 mb-8 max-w-2xl mx-auto">
            A celebration of tradition and innovation, crafted to evoke comforting flavors with a gourmet twist
          </p>
          <button
            onClick={handleContactClick}
            className="bg-[#5B2E34] text-[#EFE3D7] px-8 py-4 rounded-[14px] border border-white/20 shadow-lg hover:bg-[#4F272C] hover:shadow-xl hover:scale-105 transition-all duration-300"
          >
            Request Custom Menu
          </button>
        </div>
